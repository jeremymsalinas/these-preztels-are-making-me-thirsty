...
if r.status_code == 200:
  ...
  for i in response:
    if response[c]['agent_id'] == YOUR_AGENT_ID:
  ...
  freshTime = timedelta(hours=totalHours,minutes=totalMinutes)

  # convert to seconds
  totalSeconds = freshTime.total_seconds()
...
sherpaKey = "YOUR_SHERPA_KEY"
sherpaValue = "YOUR_SHERPA_VALUE"

tech_id = 'YOUR_TECH_ID'
...
'location_id': '0',
'status': 'open',
'subject': 'Time Summary PartsUnlimited',
'tech_id': tech_id,
'user_id': user_id}
files=[
